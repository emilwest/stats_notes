...
```{r complete_missing1, message=F, warning = F}
library(tidyverse)
...
```{r complete_missing2, message=F, warning = F}
library(tidyverse)
...
Returns a tibble of useful information from Swedish Police reports given a location and date information. More info here: https://polisen.se/om-polisen/om-webbplatsen/oppna-data/api-over-polisens-handelser/
...
The following function requires lubridate and tidyverse. Given a vector of year(s), you get dataframes with daily and weekly information in your locale.
