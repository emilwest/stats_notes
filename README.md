...
| Distribution                   | cdf ![F(x) = P(X \\\\leq x)](https://latex.codecogs.com/svg.latex?F%28x%29%20%3D%20P%28X%20%5C%5Cleq%20x%29 "F(x) = P(X \\leq x)") | Inverse cdf/quantile ![F^{-1}(p) = x](https://latex.codecogs.com/svg.latex?F%5E%7B-1%7D%28p%29%20%3D%20x "F^{-1}(p) = x") | pdf ![f(x) = P(X = x)](https://latex.codecogs.com/svg.latex?f%28x%29%20%3D%20P%28X%20%3D%20x%29 "f(x) = P(X = x)") | Generate a random variable |
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|----------------------------|
| Beta                           |                                                                                                                                    |                                                                                                                           |                                                                                                                    |                            |
| Binomial                       |                                                                                                                                    |                                                                                                                           |                                                                                                                    |                            |
| Chi-Square                     |                                                                                                                                    |                                                                                                                           |                                                                                                                    |                            |
...
![p = F(x), 0 \\\\leq p \\\\leq 1](https://latex.codecogs.com/svg.latex?p%20%3D%20F%28x%29%2C%200%20%5C%5Cleq%20p%20%5C%5Cleq%201 "p = F(x), 0 \\leq p \\leq 1")
...
plot1 <- X %>%
  ...
  annotate("text", x = q + 3, y = 0, label = str_glue("q = {q}")) +
  theme_minimal()
