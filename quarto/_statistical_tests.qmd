...
In this case, $p = 0.079 < 0.05$ indicating statistical significance and we reject the null hypothesis in favor of
the alternative that the true difference in means between group 1 and group 2 is not equal to 0.
