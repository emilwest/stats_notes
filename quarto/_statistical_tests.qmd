...
There is not enough evidence to reject the null hypothesis that the difference in mean hourly sleep increase is equal in group 1 and 2.
The mean sleep increase in group 2 is however higher, we may need a larger sample size to increase the power of the test. 
